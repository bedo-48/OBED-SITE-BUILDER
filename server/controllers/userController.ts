...
export const createUserProject = async (req: Request, res: Response) => {
    ...
    try {
        ...
        // update user credits and creation count
        ...
        const websiteGenerationResponse = await openai.chat.completions.create({
            model: 'z-ai/glm-4.5-air:free',
            messages: [
                {
                    role: 'system',
        ...
        const code = websiteGenerationResponse.choices[0].message.content || '';
